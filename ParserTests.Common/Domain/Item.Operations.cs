...
public partial class Item
{
    ...
    {
        Thread.Sleep(100); // 100ms delay for emulation
        return new() { Name = v2.Name, Value = v2.Value + v1 };
    }
    ...
    {
        Thread.Sleep(100); // 100ms delay for emulation
        return new() { Name = $"{v1.Name} {v2.Name}", Value = v2.Value + v1.Value };
    }
    ...
    {
        Thread.Sleep(100); // 100ms delay for emulation
        return new() { Name = v2.Name, Value = v2.Value + (int)Math.Round(v1, 0) };
    }
