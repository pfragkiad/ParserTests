...
{
    public DoubleParser(ILogger<DoubleParser> logger, ParserServices ps) : base(logger, ps) { }

    protected DoubleParser(ILogger logger, ParserServices ps) : base(logger, ps) { }
