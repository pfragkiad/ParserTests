...
{
    public Vector3Parser(ILogger<Vector3Parser> logger, ParserServices ps) : base(logger, ps) { }

    protected Vector3Parser(ILogger logger, ParserServices ps) : base(logger, ps) { }
